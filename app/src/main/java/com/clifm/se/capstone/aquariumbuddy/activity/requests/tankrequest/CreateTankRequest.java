...
@JsonDeserialize(builder = CreateTankRequest.Builder.class)
public class CreateTankRequest {
    private final Tank tank;

    private final String userEmail;

    private CreateTankRequest(Tank tank, String userEmail) {
        this.tank = tank;
    ...
    public static class Builder {
        ...
        public CreateTankRequest build() {
            return new CreateTankRequest(tank, userEmail);
        }
    }
}
