...
public class TankDao {
    ...
    /**
     * Retrieves a List of tanks by tankId Using a GSI Index.
     *
     * If not found, throws TankNotFoundException.
     *
     * @param tankId The tankId to look up
     *
     * @return The corresponding List of Tanks if found
     */
    public List<Tank> getTanksforTank(String tankId) {
        ...
        DynamoDBQueryExpression<Tank> queryExpression = new DynamoDBQueryExpression<Tank>()
                .withIndexName("AquariumBuddy-TanksSortByType")
